<div>
    ...
    <div class="container mx-auto p-4">
        <div class="flex justify-around items-center mb-4 p-2 bg-red-300 rounded-lg shadow-lg">
            <h2 class="text-lg font-semibold text-gray-800">Units Data Table</h2>
            ...
            <table class="w-full text-xs text-left text-gray-700 border-separate border-spacing-y-0">
                <thead class="text-gray-600 uppercase bg-gray-200">
                    <tr>
                        ...
                        <th class="px-4 py-2.5 border-b border-gray-300">Amount</th>
                        <th class="px-4 py-2.5 border-b border-gray-300">Title</th>
                ...
                <tbody>
                    ...
                    <tr class="bg-white hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-4 py-2 border-b border-gray-200">{{ $unit->name }}</td>
                        <td class="px-4 py-2 border-b border-gray-200">{{ $unit->unit_amount }}</td>
                        <td class="px-4 py-2 border-b border-gray-200">{{ $unit->unit_title }}</td>
